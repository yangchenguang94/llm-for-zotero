...
library-chat-output-format-popup-title = Output Format
library-chat-synthesis = Synthesis (All Papers)
library-chat-perpaper = Per-Paper Analysis
library-chat-disabled-tooltip = Select a collection to enable Library chat
