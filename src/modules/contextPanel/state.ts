...
export const activeConversationModeByLibrary = new Map<
  ...
  "paper" | "global"
>();
export const libraryChatOutputFormatByLibrary = new Map<
  number,
  LibraryChatOutputFormat
>();
...
// Collection-scoped global conversation tracking (Library Chat)
export const activeGlobalConversationByCollection = new Map<string, number>();
...
export function clearAllState(): void {
  ...
  activeGlobalConversationByCollection.clear();
