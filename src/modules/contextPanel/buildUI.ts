...
function buildUI(body: Element, item?: Zotero.Item | null) {
  ...
  const libraryChatFormatMenu = createElement(
    doc,
    "div",
    "llm-response-menu llm-library-chat-format-menu",
    {
      id: "llm-library-chat-format-menu",
    },
  );
  libraryChatFormatMenu.style.display = "none";
  const libraryChatFormatTitle = createElement(
    doc,
    "div",
    "llm-library-chat-format-title",
    {
      id: "llm-library-chat-format-title",
      textContent: t("Output Format"),
    },
  );
  const libraryChatSynthesisBtn = createElement(
    doc,
    "button",
    "llm-shortcut-menu-item llm-library-chat-format-option",
    {
      id: "llm-library-chat-synthesis-option",
      type: "button",
      textContent: t("Synthesis (All Papers)"),
    },
  );
  const libraryChatPerPaperBtn = createElement(
    doc,
    "button",
    "llm-shortcut-menu-item llm-library-chat-format-option",
    {
      id: "llm-library-chat-perpaper-option",
      type: "button",
      textContent: t("Per-Paper Analysis"),
    },
  );
  libraryChatFormatMenu.append(
    libraryChatFormatTitle,
    libraryChatSynthesisBtn,
    libraryChatPerPaperBtn,
  );
  container.appendChild(libraryChatFormatMenu);
  ...
  inputSection.appendChild(runtimeModeBtn);
