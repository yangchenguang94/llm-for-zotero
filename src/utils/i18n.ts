...
const zhCN: Record<string, string> = {
  ...
  "Select a collection to enable Library chat": "请选择一个分类以启用 Library chat",
  "Current collection has no papers.": "当前分类无论文。",
  ...
  "Reasoning": "推理",
  "Output Format": "输出格式",
  "Synthesis (All Papers)": "综合分析",
  "Per-Paper Analysis": "逐篇分析",
  "Send": "发送",
  "Cancel": "取消",
